...
const CategoryInputs = ({variant}) => {
  ...
  const navbarContainerClasses = "flex flex-col gap-4 text-center  sm:flex-row sm:gap-10 md:gap-4"
  ...
  const inputClasses = variant === 'navbar' ? navbarInputsClasses : popUpInputsClasses

  const containerClasses = variant === 'navbar' ? navbarContainerClasses : popUpContainerClasses
